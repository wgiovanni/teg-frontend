...
<div id="fecha" >
  ...
  <div class="row">
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="col">
                          <input type="date" id="fechaFaces" value="2018-01-01" class="form-control" >
                        </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col">
                            <input type="date"  id="fechaFacyt" value="2018-01-01" class="form-control"   >
                          </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col">
                            <input type="date"   id="fechaFace" value="2018-01-01" class="form-control" >
                          </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col">
                            <input type="date"   id="fechaFcjp" value="2018-01-01" class="form-control" >
                          </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col">
                            <input type="date"   id="fechaOdontologia" value="2018-01-01" class="form-control" >
                          </div>
                      </div>
                      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12"> 
                          <label for="first_name"  class="col col-form-label text-md-center">Ingeniería</label>
                          <div class="col">
                            <input type="date"  id="fechaIngieneria" value="2018-01-01" class="form-control" >
                          </div>
                      </div>
                      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                          <label for="first_name"  class="col col-form-label text-md-center">Fcs</label>
                          <div class="col">
                            <input type="date" id="fechaDerecho" value="2018-01-01" class="form-control" >
                          </div>
                       </div>
 ...
 <br>
  <div class="form-group text-md-center" id="boton">                       
                        <button @click="submitFile2()" class=" btn btn-primary" >Guardar</button>
  </div>
  <br>
    ...
    <!-- <div class="col-xl-6 col-md-6 col-sm-0 ">
      ...
      <div class="form-group row">
                        ...
                        <div class="col-md-12">
                          <input type="date"  id="fechaFaces" value="2019-01-01"  class="form-control" >
                        </div>
                      </div>
                    <div class="form-group row">
                        <label for="first_name" class="col-sm-1 col-form-label ">Facyt</label>
                        <div class="col-md-12">
                          <input type="date" id="fechaFacyt" value="2019-01-01" class="form-control" >
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="first_name" class="col-sm-1 col-form-label text-md-right">Face</label>
                        <div class="col-md-12">
                          <input type="date" id="fechaFace" value="2019-01-01" class="form-control" >
                        </div>
                      </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                          <input type="date"  id="fechaDerecho" value="2019-01-01" class="form-control" >
                        </div>
                      </div>
                        <div class="form-group row">
                        <label for="first_name" class="col-sm-1 col-form-label ">Fcjp</label>
                        <div class="col-md-12">
                          <input type="date" id="fechaFcjp" value="2019-01-01" class="form-control" >
                        </div>
                      </div>
                    <div class="form-group row">
                        <label for="first_name" class="col-sm-5 col-form-label text-md-left">Facultad de odontologia</label>
                        <div class="col-md-12">
                          <input type="date"  id="fechaOdontologia" value="2019-01-01"  class="form-control" >
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="first_name" class="col-sm-5 col-form-label text-md-left">Facultad de  Ingieneria</label>
                        <div class="col-md-12">
                          <input type="date"  id="fechaIngieneria" value="2019-01-01" class="form-control" >
                        </div>
                      </div>
      </form>
